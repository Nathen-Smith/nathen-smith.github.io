...
import ECE391 from './components/carousel/ECE391';
import ReactGuide from './components/carousel/ReactGuide';
...
function Layout(props) {
  ...
  return (  
    <div>
      {type==="lg" &&
        <Navbar collapseOnSelect bg={visibleNav ? "dark" : "light"} expand="md" sticky="top" 
          variant={visibleNav ? "dark" : "light"} style={{transition:'0.5s linear'}}
        >
