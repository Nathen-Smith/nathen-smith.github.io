const values = [
  ...
  },
  {
    ...
    active: { transition: "3.2s", background: "#29BEB0", width: "50%" },
  },
  ...
  {
    text: "SQL",
    before: { width: "0%", background: "#00758F" },
    active: { transition: "3.2s", background: "#00758F", width: "90%" },
  },
  {
    text: "NOSQL",
  ...
  {
    text: "Docker",
    before: { width: "0%", background: "#0db7ed" },
    active: { transition: "3.2s", background: "#0db7ed", width: "45%" },
  },
  {
    text: "Flask",
    before: { width: "0%", background: "#b19cd9" },
    active: { transition: "3.2s", background: "#b19cd9", width: "65%" },
  },
  {
    text: "C++",
    before: { width: "0%", background: "#f34b7d" },
    active: { transition: "3.2s", background: "#f34b7d", width: "75%" },
  },
  {
    text: "Github",
